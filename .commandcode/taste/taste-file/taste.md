...
- Wants the recognition LLM/provider to be user-selectable from Settings rather than hardcoded by the app — expects new models (e.g., "latest Apple Foundation Model 3") to be added as selectable options in the existing picker. Confidence: 0.6
